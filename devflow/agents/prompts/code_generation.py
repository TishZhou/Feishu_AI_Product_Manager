...
You will receive a detailed spec and must implement it precisely.
...
First explore relevant files, then produce the unified diff patch followed by ---IMPLEMENTATION_SUMMARY--- and the implementation summary."""
