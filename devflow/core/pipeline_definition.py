...
STAGE_REGISTRY: list[StageDefinition] = [
    StageDefinition(
        ...
        output_artifacts=["requirement_spec.json"],
        reads_from_stages=[],
    ...
    StageDefinition(
        ...
        output_artifacts=["solution_design.md"],
    ...
    StageDefinition(
        ...
        output_artifacts=["code_diff.patch", "implementation_summary.md"],
    ...
    StageDefinition(
        ...
        reads_from_stages=["detailed_spec", "code_generation"],
        checkpoint_after=None,
    ),
    StageDefinition(
        key="code_review",
        ...
        reads_from_stages=["detailed_spec", "code_generation", "test_generation"],
        checkpoint_after=2,
